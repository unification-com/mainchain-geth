...
# 1. install und for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for und
# 5. create und, attach and uninstall start menu entries
...
!define GROUPNAME "Unidication"
!define APPNAME "Und"
!define DESCRIPTION "Official Go implementation of the Unification protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since und is installed global
